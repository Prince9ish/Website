<?php
	...
	if($obj_con){
		$sql = "insert into cus(Name,Surname,Gender,Department,Date) VALUES('" . $arr_data['data1'] . "','" . $arr_data['data2'] ."','".$arr_data['data3']."','".$arr_data['data4']."','".$arr_data['create']."')";
